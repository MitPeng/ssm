 ...
 * Generated at: 2018-06-20 08:29:37 UTC
...
public final class role_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("  <button type=\"button\" class=\"btn btn-default\" data-toggle=\"modal\" data-target=\"#roleUpdateModel\" onclick=\"updateRole1()\">编辑</button>\r\n");
      out.write("  <button type=\"button\" class=\"btn btn-default\" onclick=\"deleteRole()\">删除</button>\r\n");
      out.write("</div></div>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("<!-- Modal -->\r\n");
      out.write("<div class=\"modal fade\" id=\"roleUpdateModel\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" >\r\n");
      out.write("  <div class=\"modal-dialog\" role=\"document\">\r\n");
      out.write("    <div class=\"modal-content\">\r\n");
      out.write("      <div class=\"modal-header\">\r\n");
      out.write("        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\r\n");
      out.write("        <h4 class=\"modal-title\" id=\"myModalLabel\">修改角色</h4>\r\n");
      out.write("      </div>\r\n");
      out.write("      <div class=\"modal-body\">\r\n");
      out.write("\t\t\r\n");
      out.write("    <fieldset>\r\n");
      ...
      out.write("\r\n");
      out.write("          <!-- Text input-->\r\n");
      out.write("          <label class=\"control-label\" for=\"input01\">编号：</label>\r\n");
      out.write("          <div class=\"controls\">\r\n");
      out.write("            <input type=\"text\"  id=\"id1\" class=\"input-xlarge\" readonly=\"readonly\">\r\n");
      out.write("          </div>\r\n");
      out.write("        </div>\r\n");
      out.write("    <div class=\"control-group\">\r\n");
      out.write("\r\n");
      ...
      out.write("          <label class=\"control-label\" for=\"input01\">角色名：</label>\r\n");
      out.write("          <div class=\"controls\">\r\n");
      out.write("            <input type=\"text\"  id=\"roleName1\" class=\"input-xlarge\">\r\n");
      out.write("          </div>\r\n");
      out.write("        </div>\r\n");
      out.write("\r\n");
      out.write("    <div class=\"control-group\">\r\n");
      ...
      out.write("          <label class=\"control-label\">  角色编码：</label>\r\n");
      out.write("          <div class=\"controls\">\r\n");
      out.write("            <input type=\"text\" id=\"roleCode1\" class=\"input-xlarge search-query\">\r\n");
      out.write("          </div>\r\n");
      out.write("\r\n");
      out.write("        </div>\r\n");
      out.write("\r\n");
      ...
      out.write("      <div class=\"modal-footer\">\r\n");
      out.write("        <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">取消</button>\r\n");
      out.write("        <button type=\"button\" onclick=\"updateRole2()\" class=\"btn btn-primary\">保存</button>\r\n");
      out.write("      </div>\r\n");
      out.write("    </div>\r\n");
      out.write("  </div>\r\n");
      out.write("</div>\r\n");
      ...
      out.write("      </div>\r\n");
      out.write("      <div class=\"modal-body\" id=\"roleAndUserModelBody\" style=\"padding-left:30px;\"></div>\r\n");
      out.write("      <div class=\"modal-footer\">\r\n");
      out.write("        <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">取消</button>\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("function updateRole1() {\r\n");
      out.write("\t$(\"#id1\").val(\"\");\r\n");
      out.write("\t$(\"#roleName1\").val(\"\");\r\n");
      out.write("\t$(\"#roleCode1\").val(\"\");\r\n");
      out.write("\tvar getSelectRows = $(\"#table\").bootstrapTable('getSelections', function (row) {\r\n");
      out.write("\t    return row;\r\n");
      out.write("\t});\r\n");
      out.write("\tif(getSelectRows.length==0){\r\n");
      out.write("\t\treturn alert(\"请选择要修改的角色！\");\r\n");
      out.write("\t}else if(getSelectRows.length!=1){\r\n");
      out.write("\t\treturn alert(\"请勿多选！\");\r\n");
      out.write("\t}\r\n");
      out.write("\tvar id = getSelectRows[0].id;\r\n");
      out.write("\tvar roleName = getSelectRows[0].roleName;\r\n");
      out.write("\tvar roleCode = getSelectRows[0].roleCode;\r\n");
      out.write("\t$(\"#id1\").val(id);\r\n");
      out.write("\t$(\"#roleName1\").val(roleName);\r\n");
      out.write("\t$(\"#roleCode1\").val(roleCode);\r\n");
      out.write("\t\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function updateRole2(){\r\n");
      out.write("\tvar id = $(\"#id1\").val();\r\n");
      out.write("\tvar roleName = $(\"#roleName1\").val();\r\n");
      out.write("\tvar roleCode = $(\"#roleCode1\").val();\r\n");
      out.write("\t$.ajax({\r\n");
      out.write("\t\turl:\"/ee/role/updateRole.do\",\r\n");
      out.write("\t\ttype:\"post\",\r\n");
      out.write("\t\tdataType:\"json\",\r\n");
      out.write("\t\tdata:{id:id,roleName:roleName,roleCode:roleCode},\r\n");
      out.write("\t\tsuccess:function(d){\r\n");
      out.write("\t\t\tif(d.code==200){\r\n");
      out.write("\t\t\t\t$('#roleUpdateModel').modal('hide');\r\n");
      out.write("\t\t\t\t$(\"#table\").bootstrapTable('refresh');\r\n");
      out.write("\t\t\t\t$(\"#id1\").val(\"\");\r\n");
      out.write("\t\t\t\t$(\"#roleName1\").val(\"\");\r\n");
      out.write("\t\t\t\t$(\"#roleCode1\").val(\"\");\r\n");
      ...
      out.write("\t});\r\n");
      out.write("\tif(getSelectRows.length==0){\r\n");
      out.write("\t\treturn alert(\"请选择要删除的角色！\");\r\n");
      out.write("\t}\r\n");
      out.write("\tvar selects = new Array();\r\n");
      out.write("\tfor(var i=0;i<getSelectRows.length;i++){\r\n");
      out.write("\t\tselects[i] = getSelectRows[i].id;\r\n");
      out.write("\t\tvar rid = selects[i];\r\n");
      out.write("\t\t$.ajax({\r\n");
      out.write("\t\t\turl:\"/ee/role/deleteRole.do\",\r\n");
      out.write("\t\t\ttype:\"post\",\r\n");
      out.write("\t\t\tdataType:\"json\",\r\n");
      ...
      out.write("\t\t\t\t\t\t              +'<input type=\"checkbox\" value=\"'+e.id+'\" name=\"userId\" checked=\"checked\">'+e.nickName \r\n");
      out.write("\t\t\t\t\t\t           +'</label>' );\r\n");
      out.write("\t\t\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#roleAndUserModelBody\").append('<label class=\"checkbox\">'\r\n");
      out.write("\t\t\t\t\t\t              +'<input type=\"checkbox\" value=\"'+e.id+'\" name=\"userId\">'+e.nickName \r\n");
      out.write("\t\t\t\t\t\t           +'</label>' );\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t})\r\n");
